...
colloc_matrix = collocation_matrix(basis_with_bc, joints)

# ╔═╡ c8ba2d55-e55b-4d84-b442-055a4f1072b5
@model function model2(x, y, 
	Ω = Ω_with_bc[2], kernel_matrix = kernel_matrix,
	colloc_matrix = colloc_matrix,
	# α_true = α_true, σ_noise_true = σ_noise
)
	n = size(Ω)[1]
	...
	reconstructed = colloc_matrix * coefs

	if any(reconstructed .< 0)
