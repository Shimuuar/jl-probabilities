...
begin
	local mass_quotient_inv = 0.8
	local mass_quotient = 1 / 0.8
	...
	init_params = (; mass_quotient, mass_quotient_inv, cos_i, observer_angle, initial_phase, offset, log_σ_common)
end

# ╔═╡ c9548f52-cb5e-441a-ae53-0d3c6ce58a3e
