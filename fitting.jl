...
# ╔═╡ c475f75e-df6d-4a09-a9f7-c2186dbf80d1
begin
	using Meshes
	using GeoTables
	import Roots
...
# ╔═╡ 508002a1-e1a8-4d6c-b591-cc2f517604ed
md"### Чтение данных"

# ╔═╡ f6883f39-48f0-4eeb-b007-f9ef320bb288
begin
...
# ╔═╡ 69880919-bd14-4d5b-9431-2848ded6cf10
scatter(
	points.day,
	points.J,
	yerr = points.J_err,
...
# ╔═╡ 6b51808c-bd92-4afc-9bb6-1b5bac3d3a33
scatter(
	points.day,
	points.K,
	yerr = points.K_err,
...
# ╔═╡ d0fbd896-c7fc-4848-b101-6a8a94e239c3
md"### Оценка периода"

# ╔═╡ f618ee98-383c-4180-b672-a59920940833
pgram = lombscargle(points.day, points.K)

# ╔═╡ 543db506-564e-4795-8f9e-a61ede7e41a4
plot(freq(pgram), power(pgram), xlabel = "частота (1/день)", title = "Lomb-Scargle periodogram, сигнал K")
...
# fit = curve_fit(
# 	(t, p) -> log_luminocity.(t, p..., Ref(interpolated_mesh), func),
# 	points.day .% period,
# 	points.K,
# 	initial_params
# )
...
begin
	...
	plot!(
		days,
		log_luminocity.(days, initial_params..., Ref(interpolated_mesh), func)
	)
end
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "26c5f4a485191970184f929a22dba666f9c1b878"
