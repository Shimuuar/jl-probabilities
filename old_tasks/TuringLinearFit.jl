...
# ╔═╡ 9017858c-a1b5-11ed-2485-497c6ebad92f
begin
	using Turing
	using MCMCChains
	using Random
...
# ╔═╡ ca6bd400-2ff1-4324-a0a7-0e2e49693215
x = [0., 2, 3, 4]

# ╔═╡ 991e7166-3076-4d5f-8ad6-7cdae855c913
k0 = 1.5

# ╔═╡ 603d3ab5-816c-4a42-84b6-1cee06a5de82
b0 = -1.0

# ╔═╡ dffcd655-0da1-4325-ae93-1e6198b7356c
σ = 0.2

# ╔═╡ aecfb6fc-944f-440e-a1c1-392aae6e655c
y_observed = k0.*x .+ b0 .+ σ.*randn(size(x))

# ╔═╡ 3c0cde75-c4ee-43a5-9b80-2c0fbde8b020
...
# ╔═╡ 7b973414-b5aa-4db5-8f10-b4f85f519948
...
# ╔═╡ ec62e771-497a-428d-992d-8eccee314360
corner(samples)

# ╔═╡ c9aacc76-befd-41f4-82c7-1104c3f6ab5f
me = mean(samples)

# ╔═╡ 68d5422a-4719-4df4-a07b-788ad4730a43
k_est, b_est = me.nt.mean

# ╔═╡ 08cb63c4-f153-4dca-b96b-f35e1532f1d4
begin
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "1af7b314f74b3048a8ec941ff1c55cab331888e8"
