...
# ╔═╡ d97c67a6-267f-4c00-a470-d815068d6f86
L(g) = g^(0.08 * 4)
...
# ╔═╡ 1bcab30a-be15-4d94-aafe-16aaefc728b3
m = interpolated_mesh(1.0);

# ╔═╡ e0122861-9b25-4ca2-970d-7f34529787c8
values(m, 0).g

# ╔═╡ 6c2ec356-9082-4521-b0c3-dd700d3dde9a
vertices(domain(m))

# ╔═╡ d272fac2-b6e4-4242-9c0f-564f6ffb5e3e
l1 = LagrangePoint_X(1.0)

# ╔═╡ e4ff8a33-b8d5-4ffe-90ad-4994c1762249
Ω0 = Ω_critical(0.5, 1.)

# ╔═╡ a4c921f3-eb54-4f71-8e17-c9dae1876de8
roche_r(Ω0, l1, 1., Point(0.999999, 0., 0.))

# ╔═╡ 4c9ee46a-1231-4128-bcad-eea953bc1142
Ω_grad(1., Vec(0.5, 0., 0.))

# ╔═╡ 93d20604-6196-440c-923a-0aeff2148690
function Ω_x_derivative(mass_quotient, x)
        -1 / x^2 - 
        mass_quotient * (1. - 1 / (x-1)^2) + 
        (1 + mass_quotient) * x
    end

# ╔═╡ 4045add0-59d2-4395-8362-a58af22239a3
Ω_x_derivative(1., 0.5)

# ╔═╡ ad4b3e5e-ae30-4063-b1e9-91e90b68e0df
vertices(domain(m))

# ╔═╡ 424af3e5-703b-46a1-be45-e87f78714517
times = 0:0.05:2π

# ╔═╡ bf561be4-5452-4062-82ae-bbf5c03fd5d8
params = [
	1., 	# mass_quotient
	π/2, 	# observer_angle
	0., 	# offset
...
# ╔═╡ 12889942-cbe2-466f-9070-6ac0a5ab686d
vals1 = log_luminocity(times, params..., interpolated_mesh, g -> g)

# ╔═╡ 535c88a1-18ec-43d4-b0ce-0bc4e60cc093
vals2 = log_luminocity(times, params..., interpolated_mesh, g -> g^(0.08 * 4))

# ╔═╡ 9f9e0027-09fe-4f6f-85df-9aff63f849e9
plot(times, [vals1 vals2 .- 0.2])
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "c731de5535d6d7cabb7c2434998d9933ce61be1b"
...
[[deps.GeoTables]]
deps = ["DataAPI", "Meshes", "PrettyTables", "Random", "ScientificTypes", "Tables", "Unitful"]
git-tree-sha1 = "cf3a1924b3d1c54526c1dbf35f47ca922b3371c8"
...
[[deps.Meshes]]
deps = ["Bessels", "CircularArrays", "Distances", "LinearAlgebra", "NearestNeighbors", "Random", "Rotations", "SparseArrays", "StaticArrays", "StatsBase", "TransformsBase"]
git-tree-sha1 = "712ecbf853688197ca76786e4cbd762899bf22f1"
